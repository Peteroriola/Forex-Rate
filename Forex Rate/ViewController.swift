...
class ViewController: UIViewController, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
      selectedCurrency = countryName[row]
       didSeleteoutput = countryCurrency[row]
        
        print(didSeleteoutput)
        
    chosenCountrylabel.text = selectedCurrency
        
        baseApiURL = "http://apilayer.net/api/live?access_key=9ff6551c664d3f2870b1eaf2e47fce5f&currencies=\(didSeleteoutput)"
